...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    SYHomePageViewController * mapKitVc = [SYHomePageViewController new];
    
    SYBaseNavgationViewController * nav = [[SYBaseNavgationViewController alloc]initWithRootViewController:mapKitVc];
